...
def execute_vm_register_first(ftd):
    ...
    Parameters: ManagedDevice object, FMC Object
    Returns:    SUCCESS, FAIL
    Raises:
    """
...
def fmc_cls_init():
    ...
    fmc = DerivedFMC(e_var['FmcIp'], e_var['FmcUserName'], e_var['FmcPassword'], e_var['FmcApiToken'], j_var['fmcAccessPolicyName'])
